...
public class ProductRepository {
	...
	public ProductRepository(ExcelReader excelReader, BasketTypeRepository basketTypeRepository){
	...
	public Product findProductById(Integer id){
		return products.stream().filter(pro -> pro.getId().equals(id)).findFirst().get();
	}
